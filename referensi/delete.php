...
<?php if ($admin==1){?>
	<div class="row row-sm mg-t-20">
		<div class="col-xl-6">
			<div class="card pd-20 pd-sm-40 form-layout form-layout-4">
				<h6 class="card-body-title">Form - Delete</h6>
			</br>
			<form action="prosesdel.php" method="POST">
				<div class="row">
					<label class="col-sm-4 form-control-label">ID_Masakan: <span class="tx-danger">*</span></label>
					<div class="col-sm-8 mg-t-10 mg-sm-t-0">
						<input type="text" name="idmsk" class="form-control" placeholder="Masukan ID_Masakan">
					</div>
				</div>
	...
	<div class="col-xl-6 mg-t-25 mg-xl-t-0">
		<div class="card pd-20 pd-sm-40 form-layout form-layout-5">
			<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Result Delete</h6>
			<center>
				<?php
				if(isset($_GET['error'])){
					if($_GET['error'] == "1"){
